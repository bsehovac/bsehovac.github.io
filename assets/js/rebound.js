...
(function() {
  ...
  util.extend(Spring.prototype, {
    ...
    setSpringSpeedFix: function(springSpeed) {
      this._springSpeed = springSpeed;
      return this;
    },
    ...
    setEndValue: function(endValue) {
      if (this._endValue == endValue && this.isAtRest(1))  {
        return this;
      }
    ...
    advance: function(time, realDeltaTime) {
      ...
      while(this._timeAccumulator >= Spring.SOLVER_TIMESTEP_SEC) {
        ...
        dxdt = this._springSpeed * (aVelocity + 2.0 * (bVelocity + cVelocity) + dVelocity);
        dvdt = this._springSpeed * (aAcceleration + 2.0 * (bAcceleration + cAcceleration) + dAcceleration);
    ...
    systemShouldAdvance: function() {
      return !this.isAtRest(1) || !this.wasAtRest();
    },
    ...
    // restSpeedThreshold.
    isAtRest: function(multiplier) {
      return Math.abs(
        this._currentState.velocity) < this._restSpeedThreshold * multiplier && (
        this.getDisplacementDistanceForState(this._currentState) <= this._displacementFromRestThreshold * multiplier ||
