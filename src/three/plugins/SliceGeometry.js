function SliceGeometry( geometry, plane, closeHoles ) {
    ...
    function distanceAsPosition(distance) {
        if (distance < 0) {
            return BACK;
        }
        if (distance > 0) {
    ...
    function findDistance(vertex, plane) {
    ...
    return sliceGeometry( geometry, plane, closeHoles );
}
